...
<link rel="stylesheet" type="text/css" href="{{asset('public/admin/lib')}}/Hui-iconfont/1.0.8/iconfont.css" />
<link rel="stylesheet" type="text/css" href="{{asset('public/admin/static')}}/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="{{asset('public/admin/static')}}/h-ui.admin/css/style.css" />
<!--[if IE 6]>
...
<meta name="description" content="吉祥教育后台系统。"></head>
<body>
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">吉祥教育</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">教育</a> 
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="{{asset('public/admin/lib')}}/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
